...
public final class ModelPathResolver {
    private static final String MODELS_PROPERTY = "biometric.models-dir";
    private static final String MODELS_ENV = "BIOMETRIC_MODELS_DIR";
    ...
    private static Path tryMaterializeClasspath(String resource) {
        ...
        try (InputStream input = ModelPathResolver.class.getClassLoader().getResourceAsStream(clean)) {
            ...
            Path temp = Files.createTempFile("face-biometric-service-", "-" + fileName);
    ...
    private static String buildNotFoundMessage(String model, String configuredRoot) {
        ...
        message.append("You may set BIOMETRIC_MODELS_DIR to an absolute model directory.");
