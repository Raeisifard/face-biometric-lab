...
public class VideoVerificationServerClient {
 ...
 public Object verify(String requestId,String referenceId,String captureMethod,byte[] clip,String filename){
  ...
  var resource=new ByteArrayResource(clip){@Override public String getFilename(){return filename;}};
    var body=new LinkedMultiValueMap<String,Object>();body.add("requestId",requestId);body.add("referenceId",referenceId);body.add("captureMethod",captureMethod);body.add("clip",resource);
